<x-filament-panels::page>
    {{-- CSS --}}
{{-- <link rel="stylesheet" href="{{ asset('assets/librerias/cssNew/login/normalize.css') }}">
<link rel="stylesheet" href="{{ asset('assets/librerias/cssNew/login/style.css') }}">
<link href="{{ asset('assets/librerias/cssNew/mainPage/remixicon/remixicon.css') }}" rel="stylesheet"> --}}
    ...
    <section class="login">
        ...
        <form wire:submit.prevent="authenticate" class="login__form">
            ...
            <figure class="login__logo">
                {{-- <img src="{{ asset('assets/librerias/imagesNew/login/icon.png') }}" class="login__img">--}}
            </figure>
...
{{-- JS --}}
{{-- <script src="{{ asset('assets/librerias/jsNew/login/particles.min.js') }}"></script>
<script src="{{ asset('assets/librerias/jsNew/login/main.js') }}"></script>--}}
</x-filament-panels::page>
